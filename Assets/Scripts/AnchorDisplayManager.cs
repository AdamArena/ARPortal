...
public class AnchorDisplayManager : MonoBehaviour
{
    ...
    private static Dictionary<string, GameObject> anchors;
    private static Dictionary<string, AnchorContent> locatedAnchors;
    ...
    protected virtual void OnAnchorLocated(object sender, AnchorLocatedEventArgs args)
    {
        UnityDispatcher.InvokeOnAppThread(() =>
        {
            ...
            // If the object has already been found, just update its position.
            ...
            else
            {
                ...
                CloudNativeAnchor nativeAnchor = anchors[anchorID].AddComponent<CloudNativeAnchor>();
            }
        });
    }
